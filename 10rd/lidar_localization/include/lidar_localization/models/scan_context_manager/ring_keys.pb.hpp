...
class RingKey final :
 ...
 public:
  ...
  ~RingKey() override;
  explicit PROTOBUF_CONSTEXPR RingKey(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  RingKey* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class RingKeys final :
 ...
 public:
  ...
  ~RingKeys() override;
  explicit PROTOBUF_CONSTEXPR RingKeys(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  RingKeys* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline ::scan_context_io::RingKey* RingKeys::add_data() {
  ::scan_context_io::RingKey* _add = _internal_add_data();
