...
public:
  ...
  ICPSVDRegistration(float max_corr_dist, float trans_eps,
...
private:
  bool SetRegistrationParam(float max_corr_dist, float trans_eps,
                            float euc_fitness_eps, int max_iter);
...
private:
  ...
  bool IsSignificant(const Eigen::Matrix4f &transformation,
