...
private:
    ...
    static constexpr int kDimMeasurementConsVel{8};

    static constexpr int kDimMeasurementPoseVel{9};
    static constexpr int kDimMeasurementPoseVelNoise{9};

    static constexpr int kDimMeasurementConsVelNoise{8};
    ...
    using MatrixGConsVel = Eigen::Matrix<double, kDimMeasurementConsVel, kDimState>;
    using MatrixCConsVel = Eigen::Matrix<double, kDimMeasurementConsVel, kDimMeasurementConsVelNoise>;
    using MatrixRConsVel = Eigen::Matrix<double, kDimMeasurementConsVelNoise, kDimMeasurementConsVelNoise>;
    ...
    using VectorYConsVel = Eigen::Matrix<double, kDimMeasurementConsVel, 1>;
    ...
    using MatrixQConsVel = Eigen::Matrix<double, kDimState * kDimMeasurementConsVel, kDimState>;
    /**
   ...
   */
    ...
    void CorrectErrorEstimationConsVel(
   ...
   */
    ...
    MatrixGConsVel GConsVel_ = MatrixGConsVel::Zero();
    MatrixCConsVel CConsVel_ = MatrixCConsVel::Zero();
    MatrixRConsVel RConsVel_ = MatrixRConsVel::Zero();
    MatrixQConsVel QConsVel_ = MatrixQConsVel::Zero();
    ...
    VectorYConsVel YConsVel_ = VectorYConsVel::Zero();
};
