...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RingKeyDefaultTypeInternal _RingKey_default_instance_;
PROTOBUF_CONSTEXPR RingKeys::RingKeys(
    ::_pbi::ConstantInitialized)
    : _impl_{
          /*decltype(_impl_.data_)*/ {}, /*decltype(_impl_._cached_size_)*/ {}} {}
struct RingKeysDefaultTypeInternal {
    PROTOBUF_CONSTEXPR RingKeysDefaultTypeInternal()
        : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RingKeysDefaultTypeInternal _RingKeys_default_instance_;
} // namespace scan_context_io
static ::_pb::Metadata file_level_metadata_ring_5fkeys_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_ring_5fkeys_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_ring_5fkeys_2eproto = nullptr;

const uint32_t TableStruct_ring_5fkeys_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ~0u, // no _has_bits_
    ...
    PROTOBUF_FIELD_OFFSET(::scan_context_io::RingKey, _impl_.data_),
    ~0u, // no _has_bits_
    ...
    ~0u, // no _weak_field_map_
    ~0u, // no _inlined_string_donated_
    PROTOBUF_FIELD_OFFSET(::scan_context_io::RingKeys, _impl_.data_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    {0, -1, -1, sizeof(::scan_context_io::RingKey)},
    {7, -1, -1, sizeof(::scan_context_io::RingKeys)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::scan_context_io::_RingKey_default_instance_._instance,
    &::scan_context_io::_RingKeys_default_instance_._instance,
};
...
static ::_pbi::once_flag descriptor_table_ring_5fkeys_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_ring_5fkeys_2eproto = {
    false,
    false,
    111,
    descriptor_table_protodef_ring_5fkeys_2eproto,
    "ring_keys.proto",
    &descriptor_table_ring_5fkeys_2eproto_once,
    nullptr,
    0,
    2,
    schemas,
    file_default_instances,
    TableStruct_ring_5fkeys_2eproto::offsets,
    file_level_metadata_ring_5fkeys_2eproto,
    file_level_enum_descriptors_ring_5fkeys_2eproto,
    file_level_service_descriptors_ring_5fkeys_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_ring_5fkeys_2eproto_getter() {
    return &descriptor_table_ring_5fkeys_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_ring_5fkeys_2eproto(&descriptor_table_ring_5fkeys_2eproto);
namespace scan_context_io {
...
inline void RingKey::SharedCtor(
...
inline void RingKey::SharedDtor() {
...
const char* RingKey::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) \
...
uint8_t* RingKey::_InternalSerialize(
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RingKey::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    RingKey::MergeImpl};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData* RingKey::GetClassData() const { return &_class_data_; }

void RingKey::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
    auto* const _this = static_cast<RingKey*>(&to_msg);
    auto& from = static_cast<const RingKey&>(from_msg);
...
inline void RingKeys::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
    (void)arena;
    (void)is_message_owned;
    new (&_impl_) Impl_{
...
inline void RingKeys::SharedDtor() {
    GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
const char* RingKeys::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) \
    if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
    while (!ctx->Done(&ptr)) {
        uint32_t tag;
...
uint8_t* RingKeys::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RingKeys::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    RingKeys::MergeImpl};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData* RingKeys::GetClassData() const { return &_class_data_; }

void RingKeys::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
    auto* const _this = static_cast<RingKeys*>(&to_msg);
    auto& from = static_cast<const RingKeys&>(from_msg);
...
template <>
PROTOBUF_NOINLINE ::scan_context_io::RingKey*
Arena::CreateMaybeMessage<::scan_context_io::RingKey>(Arena* arena) {
    return Arena::CreateMessageInternal<::scan_context_io::RingKey>(arena);
}
template <>
PROTOBUF_NOINLINE ::scan_context_io::RingKeys*
Arena::CreateMaybeMessage<::scan_context_io::RingKeys>(Arena* arena) {
