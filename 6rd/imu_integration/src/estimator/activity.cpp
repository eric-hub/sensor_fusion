...
Activity::Activity(void)
    : private_nh_("~"), initialized_(false),
...
void Activity::Init(void) {
    ...
    private_nh_.param("approximate_method", approximate_method, 1);
    std::cout << "approximate_method:" << approximate_method << std::endl;
}
...
bool Activity::GetVelocityDelta(
    ...
    if (1 == approximate_method)
        ...
        velocity_delta = linear_acc_prev * delta_t;
    return true;
}
