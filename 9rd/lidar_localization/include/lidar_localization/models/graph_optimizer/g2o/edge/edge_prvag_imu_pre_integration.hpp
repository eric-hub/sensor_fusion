...
public:
    ...
    void updateMeasurement(
        ...
        _measurement.block<3, 1>(INDEX_R, 0) = (Sophus::SO3d::exp(_measurement.block<3, 1>(INDEX_R, 0)) *
    ...
    virtual bool read(std::istream &is) override {
        ...
        Vector15d v;
        is >> v(INDEX_P + 0) >> v(INDEX_P + 1) >> v(INDEX_P + 2) >> v(INDEX_R + 0) >> v(INDEX_R + 1) >> v(INDEX_R + 2) >> v(INDEX_V + 0) >> v(INDEX_V + 1) >> v(INDEX_V + 2) >> v(INDEX_A + 0) >> v(INDEX_A + 1) >> v(INDEX_A + 2) >> v(INDEX_G + 0) >> v(INDEX_G + 1) >> v(INDEX_G + 2);
