...
class ScanContext final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ScanContext(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ScanContext* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ScanContext& from) {
    ScanContext::MergeImpl(*this, from);
  }
  private:
...
class ScanContexts final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ScanContexts(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ScanContexts* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ScanContexts& from) {
    ScanContexts::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  int32_t num_rings() const;
  void set_num_rings(int32_t value);
  private:
  int32_t _internal_num_rings() const;
  void _internal_set_num_rings(int32_t value);
  public:
  ...
  int32_t num_sectors() const;
  void set_num_sectors(int32_t value);
  private:
  int32_t _internal_num_sectors() const;
  void _internal_set_num_sectors(int32_t value);
  public:
...
inline int32_t ScanContexts::_internal_num_rings() const {
  return _impl_.num_rings_;
}
inline int32_t ScanContexts::num_rings() const {
  // @@protoc_insertion_point(field_get:scan_context_io.ScanContexts.num_rings)
  return _internal_num_rings();
}
inline void ScanContexts::_internal_set_num_rings(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.num_rings_ = value;
}
inline void ScanContexts::set_num_rings(int32_t value) {
...
inline void ScanContexts::clear_num_sectors() {
  _impl_.num_sectors_ = 0;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline int32_t ScanContexts::_internal_num_sectors() const {
  return _impl_.num_sectors_;
}
inline int32_t ScanContexts::num_sectors() const {
  // @@protoc_insertion_point(field_get:scan_context_io.ScanContexts.num_sectors)
  return _internal_num_sectors();
}
inline void ScanContexts::_internal_set_num_sectors(int32_t value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.num_sectors_ = value;
}
inline void ScanContexts::set_num_sectors(int32_t value) {
...
inline ::scan_context_io::ScanContext* ScanContexts::add_data() {
  ::scan_context_io::ScanContext* _add = _internal_add_data();
