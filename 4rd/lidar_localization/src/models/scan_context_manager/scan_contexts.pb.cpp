...
void protobuf_AssignDesc_scan_5fcontexts_2eproto() {
  ...
  ScanContext_reflection_ = ::google::protobuf::internal::
      GeneratedMessageReflection::NewGeneratedMessageReflection(
          ScanContext_descriptor_, ScanContext::default_instance_,
          ScanContext_offsets_,
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ScanContext,
                                                         _has_bits_[0]),
          -1, -1, sizeof(ScanContext),
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ScanContext,
                                                         _internal_metadata_),
          -1);
  ...
  static const int ScanContexts_offsets_[3] = {
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ScanContexts,
                                                     num_sectors_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ScanContexts, data_),
  };
  ScanContexts_reflection_ = ::google::protobuf::internal::
      GeneratedMessageReflection::NewGeneratedMessageReflection(
          ScanContexts_descriptor_, ScanContexts::default_instance_,
          ScanContexts_offsets_,
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ScanContexts,
                                                         _has_bits_[0]),
          -1, -1, sizeof(ScanContexts),
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ScanContexts,
                                                         _internal_metadata_),
          -1);
}
...
void protobuf_AddDesc_scan_5fcontexts_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(
      &protobuf_ShutdownFile_scan_5fcontexts_2eproto);
}
...
void ScanContext::SerializeWithCachedSizes(
  ...
  for (int i = 0; i < this->data_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(1, this->data(i),
                                                             output);
  }
...
bool ScanContext::IsInitialized() const { return true; }
...
// repeated float data = 1;
int ScanContext::data_size() const { return data_.size(); }
void ScanContext::clear_data() { data_.Clear(); }
...
const ::google::protobuf::RepeatedField<float> &ScanContext::data() const {
  // @@protoc_insertion_point(field_list:scan_context_io.ScanContext.data)
  return data_;
}
::google::protobuf::RepeatedField<float> *ScanContext::mutable_data() {
...
#define ZR_HELPER_(f)                                                          \
  _Pragma("clang diagnostic push")                                             \
      _Pragma("clang diagnostic ignored "                                      \
              "\"-Winvalid-offsetof\"") __builtin_offsetof(ScanContexts, f)    \
          _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f)                                                          \
  reinterpret_cast<char *>(&reinterpret_cast<ScanContexts *>(16)->f)
#endif
...
void ScanContexts::SerializeWithCachedSizes(
  ...
  if (has_num_rings()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
        1, this->num_rings(), output);
  }

  // required int32 num_sectors = 2;
  if (has_num_sectors()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
        2, this->num_sectors(), output);
  }
...
ScanContexts::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8 *target) const {
  ...
  if (has_num_rings()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(
        1, this->num_rings(), target);
  }

  // required int32 num_sectors = 2;
  if (has_num_sectors()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(
        2, this->num_sectors(), target);
  }

  // repeated .scan_context_io.ScanContext data = 3;
  for (unsigned int i = 0, n = this->data_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
        InternalWriteMessageNoVirtualToArray(3, this->data(i), false, target);
  }
...
void ScanContexts::set_has_num_rings() { _has_bits_[0] |= 0x00000001u; }
void ScanContexts::clear_has_num_rings() { _has_bits_[0] &= ~0x00000001u; }
...
void ScanContexts::set_has_num_sectors() { _has_bits_[0] |= 0x00000002u; }
void ScanContexts::clear_has_num_sectors() { _has_bits_[0] &= ~0x00000002u; }
...
// repeated .scan_context_io.ScanContext data = 3;
int ScanContexts::data_size() const { return data_.size(); }
void ScanContexts::clear_data() { data_.Clear(); }
