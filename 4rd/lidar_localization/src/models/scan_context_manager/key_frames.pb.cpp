...
void protobuf_AssignDesc_key_5fframes_2eproto() {
  ...
  Trans_reflection_ = ::google::protobuf::internal::GeneratedMessageReflection::
      NewGeneratedMessageReflection(
          Trans_descriptor_, Trans::default_instance_, Trans_offsets_,
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Trans, _has_bits_[0]),
          -1, -1, sizeof(Trans),
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Trans,
                                                         _internal_metadata_),
          -1);
  ...
  Quat_reflection_ = ::google::protobuf::internal::GeneratedMessageReflection::
      NewGeneratedMessageReflection(
          Quat_descriptor_, Quat::default_instance_, Quat_offsets_,
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Quat, _has_bits_[0]),
          -1, -1, sizeof(Quat),
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Quat,
                                                         _internal_metadata_),
          -1);
  ...
  KeyFrame_reflection_ = ::google::protobuf::internal::
      GeneratedMessageReflection::NewGeneratedMessageReflection(
          KeyFrame_descriptor_, KeyFrame::default_instance_, KeyFrame_offsets_,
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(KeyFrame,
                                                         _has_bits_[0]),
          -1, -1, sizeof(KeyFrame),
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(KeyFrame,
                                                         _internal_metadata_),
  ...
  KeyFrames_reflection_ = ::google::protobuf::internal::
      GeneratedMessageReflection::NewGeneratedMessageReflection(
          KeyFrames_descriptor_, KeyFrames::default_instance_,
          KeyFrames_offsets_,
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(KeyFrames,
                                                         _has_bits_[0]),
          -1, -1, sizeof(KeyFrames),
          GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(KeyFrames,
                                                         _internal_metadata_),
          -1);
}
...
void protobuf_AddDesc_key_5fframes_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(
      &protobuf_ShutdownFile_key_5fframes_2eproto);
}
...
Trans::Trans() : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
...
#define ZR_HELPER_(f)                                                          \
  _Pragma("clang diagnostic push")                                             \
      _Pragma("clang diagnostic ignored "                                      \
              "\"-Winvalid-offsetof\"") __builtin_offsetof(Trans, f)           \
          _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f)                                                          \
  reinterpret_cast<char *>(&reinterpret_cast<Trans *>(16)->f)
#endif
...
void Trans::MergeFrom(const ::google::protobuf::Message &from) {
  ...
  const Trans *source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Trans>(&from);
  if (source == NULL) {
...
// required float x = 1;
bool Trans::has_x() const { return (_has_bits_[0] & 0x00000001u) != 0; }
void Trans::set_has_x() { _has_bits_[0] |= 0x00000001u; }
void Trans::clear_has_x() { _has_bits_[0] &= ~0x00000001u; }
void Trans::clear_x() {
  x_ = 0;
  clear_has_x();
}
...
// required float y = 2;
bool Trans::has_y() const { return (_has_bits_[0] & 0x00000002u) != 0; }
void Trans::set_has_y() { _has_bits_[0] |= 0x00000002u; }
void Trans::clear_has_y() { _has_bits_[0] &= ~0x00000002u; }
void Trans::clear_y() {
  y_ = 0;
  clear_has_y();
}
...
// required float z = 3;
bool Trans::has_z() const { return (_has_bits_[0] & 0x00000004u) != 0; }
void Trans::set_has_z() { _has_bits_[0] |= 0x00000004u; }
void Trans::clear_has_z() { _has_bits_[0] &= ~0x00000004u; }
void Trans::clear_z() {
  z_ = 0;
  clear_has_z();
}
...
Quat::Quat() : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  SharedCtor();
...
#define ZR_HELPER_(f)                                                          \
  _Pragma("clang diagnostic push")                                             \
      _Pragma("clang diagnostic ignored "                                      \
              "\"-Winvalid-offsetof\"") __builtin_offsetof(Quat, f)            \
          _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char *>(&reinterpret_cast<Quat *>(16)->f)
#endif
...
void Quat::SerializeWithCachedSizes(
  ...
  // required float w = 1;
  if (has_w()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(1, this->w(),
                                                             output);
  }

  // required float x = 2;
  if (has_x()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(2, this->x(),
                                                             output);
  }

  // required float y = 3;
  if (has_y()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(3, this->y(),
                                                             output);
  }

  // required float z = 4;
  if (has_z()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(4, this->z(),
                                                             output);
  }
...
void Quat::MergeFrom(const ::google::protobuf::Message &from) {
  ...
  const Quat *source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Quat>(&from);
  if (source == NULL) {
...
// required float w = 1;
bool Quat::has_w() const { return (_has_bits_[0] & 0x00000001u) != 0; }
void Quat::set_has_w() { _has_bits_[0] |= 0x00000001u; }
void Quat::clear_has_w() { _has_bits_[0] &= ~0x00000001u; }
void Quat::clear_w() {
  w_ = 0;
  clear_has_w();
}
...
// required float x = 2;
bool Quat::has_x() const { return (_has_bits_[0] & 0x00000002u) != 0; }
void Quat::set_has_x() { _has_bits_[0] |= 0x00000002u; }
void Quat::clear_has_x() { _has_bits_[0] &= ~0x00000002u; }
void Quat::clear_x() {
  x_ = 0;
  clear_has_x();
}
...
// required float y = 3;
bool Quat::has_y() const { return (_has_bits_[0] & 0x00000004u) != 0; }
void Quat::set_has_y() { _has_bits_[0] |= 0x00000004u; }
void Quat::clear_has_y() { _has_bits_[0] &= ~0x00000004u; }
void Quat::clear_y() {
  y_ = 0;
  clear_has_y();
}
...
// required float z = 4;
bool Quat::has_z() const { return (_has_bits_[0] & 0x00000008u) != 0; }
void Quat::set_has_z() { _has_bits_[0] |= 0x00000008u; }
void Quat::clear_has_z() { _has_bits_[0] &= ~0x00000008u; }
void Quat::clear_z() {
  z_ = 0;
  clear_has_z();
}
...
void KeyFrame::InitAsDefaultInstance() {
  q_ = const_cast<::scan_context_io::Quat *>(
      &::scan_context_io::Quat::default_instance());
  t_ = const_cast<::scan_context_io::Trans *>(
      &::scan_context_io::Trans::default_instance());
}
...
void KeyFrame::Clear() {
  ...
  if (_has_bits_[0 / 32] & 3u) {
    if (has_q()) {
      if (q_ != NULL)
        q_->::scan_context_io::Quat::Clear();
    }
    if (has_t()) {
      if (t_ != NULL)
        t_->::scan_context_io::Trans::Clear();
    }
  }
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  if (_internal_metadata_.have_unknown_fields()) {
...
::google::protobuf::uint8 *KeyFrame::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_q()) {
    target = ::google::protobuf::internal::WireFormatLite::
        InternalWriteMessageNoVirtualToArray(1, *this->q_, false, target);
  }

  // required .scan_context_io.Trans t = 2;
  if (has_t()) {
    target = ::google::protobuf::internal::WireFormatLite::
        InternalWriteMessageNoVirtualToArray(2, *this->t_, false, target);
  }
...
bool KeyFrame::IsInitialized() const {
  ...
  if (has_q()) {
    if (!this->q_->IsInitialized())
      return false;
  }
  if (has_t()) {
    if (!this->t_->IsInitialized())
      return false;
  }
  return true;
}
...
// required .scan_context_io.Quat q = 1;
bool KeyFrame::has_q() const { return (_has_bits_[0] & 0x00000001u) != 0; }
void KeyFrame::set_has_q() { _has_bits_[0] |= 0x00000001u; }
void KeyFrame::clear_has_q() { _has_bits_[0] &= ~0x00000001u; }
...
// required .scan_context_io.Trans t = 2;
bool KeyFrame::has_t() const { return (_has_bits_[0] & 0x00000002u) != 0; }
void KeyFrame::set_has_t() { _has_bits_[0] |= 0x00000002u; }
void KeyFrame::clear_has_t() { _has_bits_[0] &= ~0x00000002u; }
    ...
    case 1: {
      ...
      parse_loop_data:
        DO_(::google::protobuf::internal::WireFormatLite::
                ReadMessageNoVirtualNoRecursionDepth(input, add_data()));
      } else {
        goto handle_unusual;
      }
      if (input->ExpectTag(10))
        goto parse_loop_data;
...
::google::protobuf::uint8 *KeyFrames::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->data_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
        InternalWriteMessageNoVirtualToArray(1, this->data(i), false, target);
  }
...
bool KeyFrames::IsInitialized() const {
  ...
  if (!::google::protobuf::internal::AllAreInitialized(this->data()))
    return false;
  return true;
}
...
// repeated .scan_context_io.KeyFrame data = 1;
int KeyFrames::data_size() const { return data_.size(); }
void KeyFrames::clear_data() { data_.Clear(); }
